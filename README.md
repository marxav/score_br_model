...
* Alternatively, the dataset file may be a *_br.txt file containing only breton sentences (e.g. [tregor_2110_br.txt](/examples/peurunvan/tregor_2110_br.txt)). 
  * In this case, another file *_fr.txt file containing the corresponding french translations must be available in the same repository and must contain exactly the same number of sentences than the *_br.tsv file (e.g. [tregor_2110_fr.txt](examples/peurunvan/tregor_2110_fr.txt))
